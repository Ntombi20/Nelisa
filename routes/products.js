...
exports.show = function(req, res, next) {
    req.getConnection(function(err, connection) {
        ...
        connection.query('SELECT products.id as product_id, products.product, categories.categoryName FROM categories inner join products on products.category_Id = categories.Id', [], function(err, results) {
            if (err) return next(err);
            res.render('products', {
                products: results,
            });
